...
const deleteUser = async (req, res) => {
  try {
    ...
    // Prevent deleting admin or security accounts
    if (user.role === "admin" || user.role === "security") {
      return res.status(403).json({ message: "Cannot delete admin or security accounts" });
    }
...
module.exports = { getAllUsers, getUserById, updateProfile, changePassword, deleteUser };
